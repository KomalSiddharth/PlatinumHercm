...
export const hercmWeeks = pgTable("hercm_weeks", {
  ...
  healthProblemsChecklist: jsonb("health_problems_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  healthFeelingsCurrentChecklist: jsonb("health_feelings_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  healthBeliefsCurrentChecklist: jsonb("health_beliefs_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  healthActionsCurrentChecklist: jsonb("health_actions_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  ...
  relationshipProblemsChecklist: jsonb("relationship_problems_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  relationshipFeelingsCurrentChecklist: jsonb("relationship_feelings_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  relationshipBeliefsCurrentChecklist: jsonb("relationship_beliefs_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  relationshipActionsCurrentChecklist: jsonb("relationship_actions_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  ...
  careerProblemsChecklist: jsonb("career_problems_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  careerFeelingsCurrentChecklist: jsonb("career_feelings_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  careerBeliefsCurrentChecklist: jsonb("career_beliefs_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  careerActionsCurrentChecklist: jsonb("career_actions_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  ...
  moneyProblemsChecklist: jsonb("money_problems_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  moneyFeelingsCurrentChecklist: jsonb("money_feelings_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  moneyBeliefsCurrentChecklist: jsonb("money_beliefs_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
  moneyActionsCurrentChecklist: jsonb("money_actions_current_checklist").$type<{ id: string; text: string; checked: boolean }[]>(),
