...
export async function fetchCourseTrackingData(sheetUrl: string): Promise<CourseTrackingData[]> {
  ...
  try {
    ...
    // REMOVED: Previous logic that nested Health, Relationship, Career, and Wealth Mastery
    // courses under Platinum Fast Track. Now they display as separate top-level courses.
