...
- **Course Tracker**: Hardcoded course structure with 2 courses: "Manifest with Chakra by Mitesh Khatri" (19 lessons) and "AI Course by Mitesh Khatri" (10 lessons). Features a dark navy theme, an overall progress bar, and persistent lesson completions. It utilizes a compact, scrollable layout.
