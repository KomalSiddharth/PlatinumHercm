...
- **Course Tracker**: Hardcoded course structure with 35 courses (10 complete + 25 placeholders awaiting lesson data): "Manifest with Chakra by Mitesh Khatri" (19 lessons), "AI Course by Mitesh Khatri" (10 lessons), "Depression To Celebration" (2 lessons), "Basic Law of Attraction Level 1" (16 lessons), "Advance Law of Attraction" (15 lessons), "Wealth Mastery" (21 lessons), "NLP - Neuro Linguistic Programming" (24 lessons), "Ho'Oponopono + EFT Certification Course" with six subcategories: "1st & 2nd Nov'25 - Latest Ho'Oponopono Batch Recording" (25 lessons), "6th&7th Sept '25 - Ho'Oponopono Batch Recording" (24 lessons), "31st May- 1st June - Ho'Oponopono Batch Recording - AI" (24 lessons), "BONUS - How to Deliver Children's Ho'oponopono" (1 lesson), "BONUS - HINDI Ho'Oponopono Healer Course" (20 lessons), and "BONUS - Special Lessons by Dr. Joe Vitale on Ho'Oponopono" (2 lessons), "Relationship mastery with Mitesh Khatri" with four subcategories: "21st &22nd June'25 - Latest Relationship Mastery Batch - AI" (17 lessons), "15th&16th Mar'25 - Relationship Mastery Batch" (15 lessons), "28th & 29th Dec'24 - Relationship Mastery Batch" (16 lessons), and "Relationship Mastery - Batch 5" (13 lessons), and "Practical Spirituality By IMK" with three subcategories: "Practical Spirituality with my guru" (32 lessons), "Practical Spirituality - Batch 2 Latest" (18 lessons), and "Practical Spirituality - Batch 1 Old" (9 lessons). Features a dark navy theme, an overall progress bar, and persistent lesson completions. It utilizes a compact, scrollable layout with support for nested subcategories. **Critical Backend Fix (Nov 8, 2025)**: Fixed inverted toggle logic where backend incorrectly treated `completed` parameter as desired state instead of current state.
