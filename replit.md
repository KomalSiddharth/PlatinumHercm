...
- **Compact View with Tooltips** (Oct 2025): Both Current Week and Next Week Target tables feature compact text display with intelligent tooltips. Text in Results, Feelings, Beliefs/Reasons, and Actions columns displays up to 3 lines with proper word wrapping. Long text (80+ characters) shows a tooltip on hover with full content. Current Week columns use simple text with tooltip; Next Week columns use editable checkpoints with tooltip support for items longer than 50 characters.
