...
- **Reporting & Analytics**: PDF export for reports, monthly progress analytics with charts, summary view, weekly progress badge (platinum standards-based), and a real-time team leaderboard.
